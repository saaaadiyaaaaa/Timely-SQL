...
import com.example.sqltodo.JSON.Event;
import com.example.sqltodo.Activities.CalendarDialog;
...
public class CalendarCard extends AppCompatActivity {
    ...
    public static Intent makeIntent(Context context) {
        return new Intent(context, CalendarCard.class);
    }
    ...
    private void onEventSelected(Event event) {
        Activity context = CalendarCard.this;
